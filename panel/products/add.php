...
?>
	...
	<section class="content-add">
		<section class="add">
			<div class="add-title"><img src="../img/regresar.png" style="cursor: pointer; margin-right: 20px;" width="70px" height="20px" onclick="window.history.back();">¿A QUE CATEGORÍA PERTENECE?<br><br><hr></div>
			<nav class="content-nav">
				<li class="nav-op" onclick="window.location='add2.php?category=juegos'">
					<div class="nav-img"><img src="../../img/juegos.png" width="120px" height="120px"></div>
					<div class="nav-title">JUEGOS</div>
				</li>
				<li class="nav-op" onclick="window.location='add2.php?category=consolas'">
					<div class="nav-img"><img src="../../img/consolas.png" width="120px" height="120px"></div>
					<div class="nav-title">CONSOLAS</div>
				</li>
				<li class="nav-op" onclick="window.location='add2.php?category=accesorios'">
					<div class="nav-img"><img src="../../img/accesorios.png" width="120px" height="120px"></div>
					<div class="nav-title">ACCESORIOS</div>
				</li>
				<li class="nav-op" onclick="window.location='add2.php?category=tarjetas'">
					<div class="nav-img"><img src="../../img/tarjetas.png" width="120px" height="120px"></div>
					<div class="nav-title">TARJETAS</div>
				</li>
				<li class="nav-op" onclick="window.location='add2.php?category=especiales'">
					<div class="nav-img"><img src="../../img/especiales.png" width="120px" height="120px"></div>
					<div class="nav-title">E. ESPECIALES</div>
				</li>
			</nav>
